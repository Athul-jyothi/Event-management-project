...
<div class="container-xl">
  ...
  <input type="submit" name="submit" value="Filter">
        ...
        try {
          ...
          $stmt = $conn->prepare("SELECT * FROM user LEFT JOIN user_to_event ON user._userId = user_to_event._userId LEFT JOIN events ON events._eventId = user_to_event._eventId WHERE user._userId = $userId;");
          $stmt->execute();
					$i = 1;
					if($stmt->rowCount() == 0) {
						echo "no data";
          ...
          while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
           ...
           ?><td>
			...
			<!-- <a href="#studentList" class="btn btn-success" data-toggle="modal"> <span>VIEW</span></a> -->
          </tr>
